...
if (isset($_GET['id'])) {
    ...
    $patient_id = filter_var($_GET['id'], FILTER_SANITIZE_NUMBER_INT);
...
<div class="container-fluid page-header-home mb-5">
    <div class="d-flex flex-column align-items-center justify-content-center px-2 pt-lg-2" style="min-height: 100px">
        <h4 class="mb-3 mt-0 mt-lg-2 text-uppercase font-weight-bold">PATIENT PRESCRIPTION </h4>
    </div>
</div>
<!-- Page Header End -->
                ...
                <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                    <div class="card" style="border-radius: 15px;">
                        ...
                        <div class="card-body p-5 pt-3">
                            ...
                            <form method="post" action="prescription-script.php" enctype="multipart/form-data">
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input value="<?= $patients['patient_name'] ?>" required type="text" readonly id="form3Example1cg" name="patient_name" class="form-control form-control-lg" />
                                </div>

                                <div class="form-outline mb-4">
                                    <label class="form-label" for="form3Example3cg">Symptoms</label>
                                    <textarea class="form-control form-control-lg" placeholder="Enter sysmptoms in point form" name="symptoms" id="" cols="30" rows="5"></textarea>
                                </div>

                                <div class="form-outline mb-4">
                                    <label class="form-label" for="form3Example3cg">Drugs prescription:</label>
                                    <textarea class="form-control form-control-lg" placeholder="Enter drug prescription with dosage" name="drugs" id="" cols="20" rows="5"></textarea>
                                </div>
                                ...
                                <div class="d-flex justify-content-center">
                                    <button type="submit" name="add_prescription" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">ADD PRESCRIPTION</button>
                                </div>
